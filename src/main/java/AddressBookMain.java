...
public class AddressBookMain {
    ...
    public static void main(String[] args) {
        ...
        AddressBookCSVService csvService=new AddressBookCSVService();
        AddressBookJSONService jsonService=new AddressBookJSONService();
        AddressBookRestService restService = new AddressBookRestService();
        ...
        while(true) {
            ...
            switch(choice) {
                ...
                {
                    try{
                        restService.getContacts();
                        restService.addContact();
                        restService.updateContact();
                        restService.deleteContact(1);
